...
namespace OnlinePizzaWebApplication.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        {
            ViewBag.CheckoutCompleteMessage = $"Thanks for your order, We'll deliver your books soon!";
            return View();
        }
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            var orderDetailsList = _context.OrderDetails.Include(o => o.Book).Include(o => o.Order)
