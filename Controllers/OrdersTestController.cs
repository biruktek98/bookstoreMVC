...
namespace OnlinePizzaWebApplication.Controllers
{
    public class OrdersTestController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,FirstName,LastName,Address,City,Country,PhoneNumber,Email")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,FirstName,LastName,Address,City,Country,PhoneNumber,Email")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
